...
int int_gt_ulong(int i, unsigned LONG64 ul) {
    // common type is unsigned LONG64
    return i > ul;
}

int uint_gt_long(unsigned int u, LONG64 l) {
    // common type is LONG64
    return u > l;
}

int uint_lt_ulong(unsigned int u, unsigned LONG64 ul) {
    // common type is unsigned LONG64
    return u < ul;
}

int long_gt_ulong(LONG64 l, unsigned LONG64 ul) {
    // common type is unsigned LONG64
    return l > ul;
}
...
int main(void) {
    ...
    // converting -1 to unsigned LONG64 gives us 2^64-1, i.e. INT_MAX
    // 18446744073709551606 is 2^64 - 10
    if (!(int_gt_ulong(-1, 18446744073709551606ul))) {
        return 2;
    }

    // converting 100u to a signed LONG64 won't change its value
    ...
    // converting an unsigned int to an unsigned LONG64 won't change its value
    ...
    // converting -1 from LONG64 to unsigned LONG64 gives us 2^64 -1, so -1l > 1000ul
